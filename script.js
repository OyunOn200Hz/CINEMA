function fetchAndDisplayMovie(idFilms, posterElementId, descriptionFilm, titleElementId) {
    fetch(`https://www.omdbapi.com/?apikey=586caa23&i=${(idFilms)}&type=movie`)
...
function addClickListenerToFilmDiv(filmDiv, filmId) {
...
document.querySelectorAll('.EnAvant > div').forEach((filmDiv, index) => {
    const filmId = ['tt0816692', 'tt15398776', 'tt0137523'][index];
    addClickListenerToFilmDiv(filmDiv, filmId);
});
